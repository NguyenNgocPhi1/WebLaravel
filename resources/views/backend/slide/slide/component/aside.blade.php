    ...
    <div class="ibox-content">
        <div class="row mb15">
            <div class="col-lg-12 mb10">
                <div class="form-row">
                    <label for="" class="control-lable text-left">Tên Slide
            ...
            <div class="col-lg-12">
                <div class="form-row">
                    <label for="" class="control-lable text-left">Từ khóa Slide
                        <span class="text-danger">(*)</span>
                    </label>
                    <input type="text"
                            name="keyword"
                        ...
                        <div class="uk-flex uk-flex-middle">
                            ...
                            <div class="setting-value">
                                <input 
                                    ...
                                    name="setting[arrow]" 
                                    value="accept"
                                    @if(old('setting.arrow', ($slide->setting['arrow']) ?? null) == 'accept' || $config['method'] == 'create')
                                        checked="checked"
                                    @endif
                                >
                            </div>
                            ...
                            <div class="setting-value">
                                ...
                                <div class="nav-setting-item uk-flex uk-flex-middle">
                                    <input 
                                        ...
                                        value="{{ $key }}" 
                                        id="navigate_{{ $key }}"
                                        {{ (old('setting.navigate', ($config['method'] == 'create') ? 'dots' : (($slide->setting['navigate']) ?? null)) === $key) ? 'checked' : '' }}
                                    >
            ...
            <div class="uk-flex uk-flex-middle">
                ...
                <div class="setting-value">
                    <input 
                        ...
                        value="accept"
                        @if(old('setting.autoplay', ($slide->setting['autoplay']) ?? null) == 'accept' || $config['method'] == 'create')
            ...
            <div class="uk-flex uk-flex-middle">
                ...
                <div class="setting-value">
                    <input 
                        ...
                        value="accept"
                        @if(old('setting.pauseHover', ($slide->setting['pauseHover']) ?? null) == 'accept' || $config['method'] == 'create')
                        checked="checked" @endif
                    >
                </div>
            </div>  
