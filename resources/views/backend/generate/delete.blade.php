...
<form action="{{route('generate.destroy', $generates->id)}}" method="post" class="box">
    @csrf
    @method('delete')
            ...
            <div class="col-lg-5">
                <div class="panel-head">
                    ...
                    <div class="panel-description">
                        <p>- Bạn đang muốn xóa dữ liệu có tên là: <span class="text-danger">{{ $generates->name }}</span></p>
