    ...
    <div class="ibox">
        ...
        <div class="ibox-content">
            <div class="form-row mb15">
                <label for="" class="control-lable text-left">Ngày bắt đầu <span class="text-danger">(*)</span></label>
                <div class="form-date">
                    <input 
                        type="text"
                        name="startDate"
            ...
            <div class="form-row mb15">
                <label for="" class="control-lable text-left">Ngày kết thúc <span class="text-danger">(*)</span></label>
                <div class="form-date">
                    <input 
                        type="text"
                        name="endDate"
                        value="{{ old('endDate', isset($model->startDate) ? (convertDateTime($model->endDate)) : '') }}"
                        class="form-control datepicker"
                        placeholder=""
                        autocomplete="off"
