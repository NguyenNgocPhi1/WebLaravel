            ...
            <div class="col-lg-9">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        @include('backend.dashboard.component.content', ['model' => ($postCatalogues) ?? null])
                    </div>
                </div>
                @include('backend.dashboard.component.album', ['model' => ($postCatalogues) ?? null])
                @include('backend.dashboard.component.seo', ['model' => ($postCatalogues) ?? null])
            </div>
            <div class="col-lg-3">
