...
class StorePromotionRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        ...
        $messages = [
            'name.required' => 'Bạn chưa nhập tên chương trình của khuyến mại.',
            'code.required' => 'Bạn chưa nhập mã khuyến mại.',
            'code.unique' => 'Mã khuyến mại đã tồn tại, hãy chọn mã khuyến mại khác.',
            'startDate.required' => 'Bạn chưa chọn ngày bắt đầu khuyến mại.',
            'startDate.custom_date_format' => 'Ngày bắt đầu khuyến mại không đúng định.',
            'endDate.required' => 'Bạn chưa chọn ngày kết thúc khuyến mại.',
            'endDate.custom_date_format' => 'Ngày kết thúc khuyến mại không đúng định.',
        ];
        ...
        if(!$this->input('neverEndDate')){
            $messages['endDate.required'] = 'Bạn chưa chọn ngày kết thúc khuyến mại.';
