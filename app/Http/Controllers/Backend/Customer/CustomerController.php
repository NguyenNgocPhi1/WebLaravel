...
class CustomerController extends Controller
{
    ...
    public function store(StoreCustomerRequest $request){
        ...
        return redirect()->route('customer.index')->with('error','Thêm mới bản ghi thất bại. Hãy thử lại');    
    }
    ...
    public function update($id,UpdateCustomerRequest $request){
        ...
        return redirect()->route('customer.index')->with('error','Cập nhật bản ghi thất bại. Hãy thử lại');    
    }
    ...
    public function destroy($id){
        ...
        return redirect()->route('customer.index')->with('error','Xóa bản ghi thất bại. Hãy thử lại');  
    }
