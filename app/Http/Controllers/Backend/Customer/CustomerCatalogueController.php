...
class CustomerCatalogueController extends Controller
{
    ...
    public function store(StoreCustomerCatalogueRequest $request){
        ...
        return redirect()->route('customer.catalogue.index')->with('error','Thêm mới bản ghi thất bại. Hãy thử lại');    
    }
    ...
    public function update($id,StoreCustomerCatalogueRequest $request){
        ...
        return redirect()->route('customer.catalogue.index')->with('error','Cập nhật bản ghi thất bại. Hãy thử lại');    
    }
    ...
    public function destroy($id){
        ...
        return redirect()->route('customer.catalogue.index')->with('error','Xóa bản ghi thất bại. Hãy thử lại');  
    }
