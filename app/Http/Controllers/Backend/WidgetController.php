...
class WidgetController extends Controller
{
    ...
    public function store(StoreWidgetRequest $request){
        ...
        return redirect()->route('widget.index')->with('error','Thêm mới bản ghi thất bại. Hãy thử lại');    
    }
    ...
    public function edit($id){
        ...
        $widgetItem = convertArrayByKey($modelClass->findByCondition(...array_values($this->menuItemAgrument($widget->model_id))), ['id', 'name.languages', 'image']);
        $config = $this->config();
        $config['seo'] = __('messages.widget');
        $config['method'] = 'edit';
        $template = 'backend.widget.store';
    ...
    public function update($id,UpdateWidgetRequest $request){
        ...
        return redirect()->route('widget.index')->with('error','Cập nhật bản ghi thất bại. Hãy thử lại');    
    }
    ...
    public function destroy($id){
        ...
        return redirect()->route('widget.index')->with('error','Xóa bản ghi thất bại. Hãy thử lại');  
    }
    ...
    public function saveTranslate(Request $request){
        ...
        return redirect()->route('widget.index')->with('error','Tạo bản dịch thất bại. Hãy thử lại');  
    }
