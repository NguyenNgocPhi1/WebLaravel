...
class {$class}Controller extends Controller
{
    ...
    public function store(Store{$class}Request $request){
        ...
        return redirect()->route('{module}.index')->with('error','Thêm mới bản ghi thất bại. Hãy thử lại');    
    }

    public function edit($id){
        $this->authorize('modules', '{module}.update');
        ${module}s = $this->{module}Repository->get{$class}ById($id,$this->language);
        $config = $this->configData();
        $config['seo'] = __('messages.{module}');
        $config['method'] = 'edit';
        $dropdown = $this->nestedset->Dropdown();
    ...
    public function update($id,Update{$class}Request $request){
        ...
        return redirect()->route('{module}.index')->with('error','Cập nhật bản ghi thất bại. Hãy thử lại');    
    }
    ...
    public function destroy($id){
        ...
        return redirect()->route('{module}.index')->with('error','Xóa bản ghi thất bại. Hãy thử lại');  
    }
