...
class System
{
	public function config(){
		...
		$data['social'] = [
			'label' => 'Cấu hình về Mạng xã hội dành cho trang chủ',
			'description' => 'Cài đặt đầy đủ thông tin về về Mạng xã hội của trang chủ Website. Bao gồm: Tiêu đề về Mạng xã hội, Từ khóa về Mạng xã hội, Mô tả về Mạng xã hội, Meta images',
			'value' => [
